...
module.exports = function fly(mod) {
  ...
  */
	...
	mod.hook("C_PLAYER_LOCATION", 5, (e) => !([2, 10].includes(e.type) && (currZone < 10 || currZone > 200)));
	...
	mod.hook("C_START_SKILL", 7, { order: -999 }, (event) => unmount());

	mod.hook("C_PRESS_SKILL", 4, { order: -999 }, (event) => unmount());
	...
	mod.hook("S_CANT_FLY_ANYMORE", 1, (event) => false);
